...
<html lang="en" dir="ltr">
  ...
  <head>
    <meta charset="utf-8">
    <!-- Page Title-->
    <title>Pixel Peak</title>

    <!-- Meta Tags-->
    <meta name="description" content="Beldon - awesome coming soon template to kick-start your project">
    ...
    <link rel="icon" href="{{ url('website/img/favicon/favicon.ico') }}" sizes="any">
    <link rel="icon" href="{{ url('website/img/favicon/icon.svg') }}" type="image/svg+xml">
    <link rel="apple-touch-icon" href="{{ url('website/img/color-1/apple-touch-icon.png') }}">
    <link rel="manifest" href="{{ url('website/img/favicon/manifest.webmanifest') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('website/css/loaders/loader-dark.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('website/css/plugins.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('website/css/main.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('website/css/colors/color-dark.css') }}">

    <!-- Template Styles End -->

    <!-- Custom Browser Color Start -->
    <meta name="theme-color" content="#563789">
    <meta name="msapplication-navbutton-color" content="#563789">
    <meta name="apple-mobile-web-app-status-bar-style" content="#563789">
  ...
  <body>
    ...
    <div class="loader">
      <div class="loader-content">
        <div class="loader-logo fadeIn">
          <!-- Your Logo Here -->
          <img src="{{ url('website/img/logo.png') }}" alt="Pixel Peak - Coming Soon and Landing Page Template">
        </div>
      </div>
    </div>
    <!-- Loader End -->
    ...
    <header id="header" class="header dark">
      ...
      <div class="header__logo">
        <!-- Your Logo Here -->
        <img src="{{ url('website/img/logo.png') }}" alt="Beldon Template Logo" class="header__logo--img" width="100">
        <!-- <span class="header__logo--text">Pixel Peak</span> -->
      </div>
      <!-- Template Logo End -->
    ...
    <nav id="nav" class="nav">
      ...
      <div class="color-layer color-layer-svg color-layer-svg-menu"></div>
      <div class="container-fluid p-0 fullheight">
        <div class="row g-0 fullheight">
          <div class="col-12 col-xl-6 nav__menu">

            <!-- Menu Start -->
            <ul class="menu">
              <!-- menu single item -->
              <li class="menu__item">
                <a href="#0" id="main-trigger" class="menu__link active-trigger link-l" data-ref="home">
                  <span class="link__number">01.</span>
                  <span class="link__caption">Home</span>
                </a>
              </li>
              <!-- menu single item -->
              <li class="menu__item">
                <a href="#0" id="about-trigger" class="menu__link link-l" data-ref="about">
                  <span class="link__number">02.</span>
                  <span class="link__caption">About us</span>
                </a>
              </li>
              <!-- menu single item -->
              <li class="menu__item">
                <a href="#0" id="works-trigger" class="menu__link link-l" data-ref="works">
                  <span class="link__number">03.</span>
                  <span class="link__caption">Our works</span>
                </a>
              </li>
              <!-- menu single item -->
              <li class="menu__item">
                <a href="#0" id="contact-trigger" class="menu__link link-l" data-ref="contact">
                  <span class="link__number">04.</span>
                  <span class="link__caption">Contact</span>
                </a>
              </li>
            </ul>
            <!-- Menu Start -->
        ...
        <div class="row g-0 fullheight">
          ...
          <div class="col-12 col-xl-6 main__intro">
            ...
            <div class="alert alert-success" role="alert">
               You are subscribed successfully in PixelPeak
            </div>
            @endif
           ...
           @if($errors->has('email'))
            ...
            @endif
              ...
              <h1 class="headline__title">Ideas in Pixel, <br>Success in Reality</h1>
              <p class="headline__descr">
Dedicated to transforming your digital visions into reality, right at your doorstep.              </p>
            ...
            <div id="notify" class="notify">
              ...
              <div class="popup-controls">
                <a href="#0" id="notify-close" class="notify-close link-s"></a>
              </div>
              <!-- Popup Controls End -->
              ...
              <div class="popup-content">
                ...
                <div class="form-container">
                  ...
                  <div class="reply-group subscription-ok">
                    <svg class="reply-group__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      <path d="M0 0h24v24H0V0z" fill="none"/>
                      <circle cx="15.5" cy="9.5" r="1.5"/>
                      <circle cx="8.5" cy="9.5" r="1.5"/>
                      <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12
                      20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm-5-6c.78 2.34 2.72 4 5 4s4.22-1.66 5-4H7z"/>
                    </svg>
                  ...
                  <div class="reply-group subscription-error">
                    <svg class="reply-group__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                      ...
                      0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-6c-2.33 0-4.32 1.45-5.12 3.5h1.67c.69-1.19 1.97-2 3.45-2s2.75.81 3.45 2h1.67c-.8-2.05-2.79-3.5-5.12-3.5z"/>
                    </svg>
                  ...
                  <form action ="{{ route('subscribe') }}" class="form notify-form" method="post">
                    {{ csrf_field() }}
                    <input value="" class="margin-s" type="email" placeholder="Email Adress*" required="" name="email">
            ...
            <div class="intro__socials">
              <ul class="socials socials-text">
                <li>
                  <a href="https://www.facebook.com/pixel.peakagency" target="_blank" class="link-s">Facebook</a>
                </li>
                <li>
                  <a href="https://www.instagram.com/pixel.peakagency/" target="_blank" class="link-s">Instagram</a>
                </li>
               <li>
                  <a href="https://www.linkedin.com/company/96061315/admin/feed/posts/" target="_blank" class="link-s">Linkedin</a>
                </li>
              </ul>
            </div>
            <!-- Intro Socials End -->

            <!-- Intro Copyright Start -->
            <!-- <div class="intro__copyright">
              <p class="copyright">
                <a href="https://themeforest.net/user/mix_design/portfolio" target="_blank" class="link-s">Mix_design</a>, 2023
              </p>
            </div> -->
            <!-- Intro Copyright End -->
          ...
          <div class="col-12 col-xl-6 main__media">
              ...
              <div class="swiper-2">
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    ...
                    <span class="slide-caption" data-swiper-parallax="150" data-swiper-parallax-opacity="0.5">01/04</span>
                  </div>
                  <!-- slide single -->
                  <div class="swiper-slide">
                    <div class="slide-image swiper-image-2">
                      <div class="color-layer color-layer-gradient"></div>
                    </div>
                    <span class="slide-caption" data-swiper-parallax="150" data-swiper-parallax-opacity="0.5">02/04</span>
                  </div>
                  <!-- slide single -->
                  <div class="swiper-slide">
                    <div class="slide-image swiper-image-3">
                      <div class="color-layer color-layer-black"></div>
                    </div>
                    <span class="slide-caption" data-swiper-parallax="150" data-swiper-parallax-opacity="0.5">03/04</span>
                  </div>
                  <!-- slide single -->
                  <div class="swiper-slide">
                    <div class="slide-image swiper-image-4">
                      <div class="color-layer color-layer-black"></div>
                    </div>
                    <span class="slide-caption" data-swiper-parallax="150" data-swiper-parallax-opacity="0.5">04/04</span>
                  </div>
                  <!-- slide single -->
                  <!-- <div class="swiper-slide">
                    <div class="slide-image swiper-image-5">
                      <div class="color-layer color-layer-black"></div>
                    </div>
                    <span class="slide-caption" data-swiper-parallax="150" data-swiper-parallax-opacity="0.5">05/05</span>
                  </div> -->
                </div>
                <!-- Navigation buttons -->
            ...
            <!-- Media Cover (is visible when Notify is open) Start -->
            <div class="media__cover color-layer color-layer-gradient"></div>
            <!-- Media Cover (is visible when Notify is open) End -->
    ...
    <section id="about" class="inner about">
      <div class="inner__container">
        ...
        <!-- About Section Intro Start -->
        <div class="inner__intro about-intro fullscreen">
          <!-- gradient layer -->
          <div class="color-layer color-layer-gradient-bottom"></div>
          <!-- intro animated caption -->
          <div class="intro__caption">
            <div class="container-fluid px-4">
              <div class="row gx-5">
                <div class="col-12">
                  <p class="section-slogan">
                    <span class="left">Creativity is</span>
                    <span class="right">above all</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <!-- scroll down button -->
          <a href="#about-content" class="intro__scroll link-s"></a>
        </div>
        <!-- About Section Intro End -->

        <!-- About Section Content Start -->
        <div id="about-content" class="inner__content">
          ...
          <div class="content-wrapper">
            <div class="container-fluid px-0">
              <div class="row gx-0">
                ...
                <div class="col-12 col-xl-6 svg-background-2">
                  <!-- About Us Description Start -->
                  <div class="content-block">
                    <span class="block__subtitle">About Us</span>
                    <h2 class="block__title">Just awesome<br>template</h2>
                    <p class="block__text half-text">I wonder if I've been changed in the night?
                      Let me think. Was I the same when I got up this morning?
                      I almost think I can remember feeling a little different.
                      But if I m not the same, the next question is 'Who in the world am I?' Ah, that's the great puzzle!
                    </p>
                    <div class="block__btnholder">
                      <a href="https://vimeo.com/65036292" id="showreel-trigger" class="button round-button link-l">
                        <span class="button__caption">Showreel</span>
                        <span class="button__icon">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0z" fill="none"/>
                            <path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/>
                ...
                <div class="col-12 col-xl-6 half-content">
                  <!-- About Us Image Block #1 Start -->
                  <div class="image-block image-block-3"></div>
                  <!-- About Us Image Block #1 End -->
                </div>

              </div>
              <div class="row gx-0 flex-xl-row-reverse">
                    ...
                    <div class="skillbars">
                      ...
                      <div class="show-skillbar">
                        <div class="skillbar light" data-percent="96">
                          <span class="skillbar-title light">Design</span>
                      ...
                      <div class="show-skillbar">
                        <div class="skillbar light" data-percent="84">
                          ...
                          <span class="skill-bar-percent light">84%</span>
                        </div>
                      </div>
                      <!-- Skillbar single item -->
                      <div class="show-skillbar">
                        <div class="skillbar light" data-percent="90">
                          <span class="skillbar-title light">Marketing</span>
                      ...
                      <div class="show-skillbar">
                        <div class="skillbar light" data-percent="73">
                          <span class="skillbar-title light">Selling</span>
                ...
                <div class="col-12 col-xl-6">
                  <!-- About Us Image Block #2 Start -->
                  <div class="image-block image-block-4"></div>
                  <!-- About Us Image Block #2 End -->
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- About Media Part Start -->
          <div class="media-wrapper">
            <!-- Video Popup Trigger Block Start -->
          ...
          <!-- About Media Part End -->

          <!-- About Content Part Start -->
          <div class="content-wrapper svg-background-1">
            <div class="container-fluid px-0">
    ...
    <section id="works" class="inner works">
      <div class="inner__container">
        ...
        <!-- Works Section Intro Start -->
        <div class="inner__intro works-intro fullscreen">
          <!-- gradient layer -->
          <div class="color-layer color-layer-gradient-bottom"></div>
          <!-- intro animated caption -->
          <div class="intro__caption">
            <div class="container-fluid px-4">
              <div class="row gx-5">
                <div class="col-12">
                  <p class="section-slogan">
                    <span class="left">Creating</span>
                    <span class="right">unique stuff</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <!-- scroll down button -->
          <a href="#works-content" class="intro__scroll link-s"></a>
        </div>
        <!-- Works Section Intro End -->

        <!-- Works Section Content Start -->
        <div id="works-content" class="inner__content">

          <!-- Works Content Part Start -->
          <div class="content-wrapper svg-background-4">
            <div class="container-fluid px-0">
              <div class="row gx-0">
                <div class="col-12">

                  <!-- Works Description Start -->
                  <div class="content-block">
                    <span class="block__subtitle">Portfolio</span>
                    <h2 class="block__title">Meet our featured<br>projects</h2>
                    <div class="container-fluid px-0">
                      <div class="row gx-5 my-gallery"  itemscope itemtype="http://schema.org/ImageGallery">
                        ...
                        <figure class="col-12 col-md-6 col-xl-4 my-gallery__item link-l"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                          <a href="https://dummyimage.com/1200x800/6b388f/b168e6" data-image="https://dummyimage.com/1200x800/6b388f/b168e6" class="works-link" itemprop="contentUrl" data-size="1200x800">
                            <img src="https://dummyimage.com/1200x800/6b388f/b168e6" class="works-image" itemprop="thumbnail" alt="Image description" />
                          </a>
                        ...
                        <figure class="col-12 col-md-6 col-xl-4 my-gallery__item link-l"  itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                          ...
                          <figcaption class="my-gallery__descr" itemprop="caption description">
                            <h3>
                              Agency app
                              <small>Consept / App design</small>
                            </h3>
                            <p class="light">Why, sometimes I've believed as many as six impossible things before breakfast.</p>
                          </figcaption>
                        </figure>
                  ...
                  <!-- Works Description End -->

                </div>
              </div>
            </div>
          </div>
          <!-- Works Content Part End -->

          <!-- Works Media Part Start -->
          <div class="media-wrapper">
            <!-- Slider main container -->
            <div class="swiper-works">
              ...
              <div class="swiper-wrapper">
                <!-- Slides -->
                <div class="swiper-slide works-slide works-slide-1"></div>
                <div class="swiper-slide works-slide works-slide-2"></div>
                <div class="swiper-slide works-slide works-slide-3"></div>
              </div>
              <!-- Pagination -->
              ...
              <div class="row gx-0">
                <div class="col-12">
                  <div class="content-block">
                    ...
                    <!-- Team Members Start -->
                    <div class="container-fluid px-0">
                      <div class="row gx-5 team">
                        <!-- team single item -->
                        <div class="col-12 col-md-6 col-xl-3 team__item">
                          <img class="team__image" src="https://dummyimage.com/1200x1200/6b388f/b168e6" alt="Beldon Template Team Image">
                          <h4>
                            John Lemon
                            <small>Brand manager</small>
                          </h4>
                          <p class="team__descr">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce posuere massa.</p>
                          <ul class="team__socials socials socials-icons">
                            <li>
                              <a href="https://www.facebook.com/" target="_blank" class="link-s"><i class="fa-brands fa-facebook-f"></i></a>
                            </li>
                            <li>
                              <a href="https://www.instagram.com/" target="_blank" class="link-s"><i class="fa-brands fa-instagram"></i></a>
                            </li>
                            <li>
                              <a href="https://twitter.com/" target="_blank" class="link-s"><i class="fa-brands fa-twitter"></i></a>
                            </li>
                          </ul>
                        </div>
                        <!-- team single item -->
    ...
    <section id="contact" class="inner contact">
      <div class="inner__container">
        ...
        <!-- Contact Section Intro Start -->
        <div class="inner__intro contact-intro fullscreen">
          <!-- gradient layer -->
          <div class="color-layer color-layer-gradient-bottom"></div>
          <!-- intro animated caption -->
          <div class="intro__caption">
              ...
              <div class="row gx-5">
                <div class="col-12">
                  <p class="section-slogan">
                    ...
                    <span class="right">get in touch</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <!-- scroll down button -->
          <a href="#contact-content" class="intro__scroll link-s"></a>
        </div>
        <!-- Contact Section Intro End -->

        <!-- Contact Section Content Start -->
        <div id="contact-content" class="inner__content">

          <!-- Contact Content Part Start -->
          <div class="content-wrapper svg-background-3">
            <div class="container-fluid px-0">
              <div class="row gx-0">
                <div class="col-12">
                  <div class="content-block">
                    ...
                    <div class="container-fluid px-0">
                      <div class="row gx-0">
                        <div class="col-12 col-xl-6">
                          ...
                          <h2 class="block__title">Welcome to our new office</h2>
                          <p class="block__text">Our website is under construction but we are ready to go!
                            You can call us or leave a request here. We are always glad to see you in our office from
                            <span>9:00</span> to
                            <span>18:00</span>.
                          </p>
                        </div>
                            ...
                            <div class="row gx-5">
                              ...
                              <div class="col-12 col-md-6 contact-data__item">
                                ...
                                <ul>
                                  ...
                                  <li>
                                    <a href="https://twitter.com/" target="_blank" class="link-s">Twitter</a>
                                  </li>
                                  <li>
                                    <a href="https://dribbble.com/" target="_blank" class="link-s">Dribbble</a>
                                  </li>
                                </ul>
                              </div>
                              <!-- contact data single item -->
                              ...
                              <form  class="form contact-form" id="contact-form" >
                                ...
                                <div class="container-fluid px-0">
                                  <div class="row gx-5">
                                    ...
                                    <div class="col-12">
                                      <span class="inputs-description">*Required fields</span>
                                      <button type="submit" class="btn btn-solid link-l">
                                        <span>Submit</span>
                                      </button>
                                    </div>
                                  </div>
          ...
          <!-- Contact Media Part Start -->
          <div class="media-wrapper">

            <!-- Google Map Start -->
            <div id="google-map" class="google-map">
              <div id="google-container"></div>
              <div id="zoom-in" class="link-l">
                <i class="btn-icon fa-solid fa-plus"></i>
              </div>
              <div id="zoom-out" class="link-l">
    ...
    <script src="{{ url('website/js/libs.min.js') }}"></script>
    <script src="{{ url('website/js/gallery-init.js') }}"></script>
    <script src="{{ url('website/js/beldon-custom.js') }}"></script>
    <script src="{{ url('website/js/maps/map-dark.js') }}"></script>
